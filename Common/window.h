...
public:
    ...
    using KeyboardKeyHandler = std::function<void(int, int)>;
    ...
    void AddKeyboardKeyHandler(const KeyboardKeyHandler& handler);
...
private:
    ...
    std::vector<KeyboardKeyHandler> keyboardKeyHandlers;
